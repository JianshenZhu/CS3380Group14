...
//grabbed this function from my lab6 code
function openDB()  {

    //made a config in our main directory
    //possibly could put this function in another php file similar to config so you can just use function name in files
    //*update* looks like you might not be able to use functions 
    include "../../../CONFIG.php";
...
function handle_login() {
    ...
    if (!$stmt->prepare("
        SELECT Authentication.UserID, Password, Roles, FirstName, LastName
        FROM Authentication
        JOIN Person
